...
class Api::V2::ExternalUsergroupsControllerTest < ActionController::TestCase
  ...
  test 'show an external user group' do
    get :show, params: { :usergroup_id => @external_usergroup.usergroup_id, :id           => @external_usergroup.id }
    assert_response :success
  ...
  test 'create external user group' do
    ...
    assert_difference('usergroup.external_usergroups.count') do
      post :create, params: { :usergroup_id       => usergroup.to_param, :external_usergroup => valid_attrs }
    end
  ...
  test 'refresh external user group' do
    ...
    put :refresh, params: { :usergroup_id => @external_usergroup.usergroup_id, :id           => @external_usergroup.id }
    assert_response :success
  end
  ...
  test 'update a external user group' do
    ...
    put :update, params: { :usergroup_id => @external_usergroup.usergroup_id, :id => @external_usergroup.id, :external_usergroup => valid_attrs }
    assert_response :success
  ...
  test 'destroy external user group' do
    ...
    assert_difference('ExternalUsergroup.count', -1) do
      delete :destroy, params: { :usergroup_id => @external_usergroup.usergroup_id, :id           => @external_usergroup.id }
    end
    assert_response :success
  end
end
